...
class ClassificationService:
    ...
    @staticmethod
    def _save_classification_history( filename, model_name, scaler_type, total_records, target_column, metrics, user=None, ):
    ...
    @staticmethod
    def process( df, filename=None, model_name="random_forest", scaler_type="standard", user=None, ):
