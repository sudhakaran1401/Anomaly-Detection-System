...
# Django/HS256 requires a sufficiently long signing key.  Keep a safe
# development fallback for local/test environments, while refusing an
# insecure key in production.
if len(SECRET_KEY) < 32:
    if DEBUG:
        SECRET_KEY = "django-insecure-anomaly-detection-dev-key-32chars"
    else:
...
USE_X_FORWARDED_PROTO = config( "USE_X_FORWARDED_PROTO", cast=bool, default=False, )
