...
class DetectionHistory(models.Model):
    ...
    dataset_type = models.CharField( max_length=20, default="unlabelled" )
    ...
    def __str__(self):
        ...
        return ( f"{self.filename}" f" - " f"{self.model_name}" )
...
class TrainedModel(models.Model):
    ...
    model_name = models.CharField(max_length=100)
    algorithm = models.CharField( max_length=50, choices=MODEL_CHOICES )
